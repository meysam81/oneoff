...
export const jobsAPI = {
  ...
  clone: (id, scheduledAt) =>
    api
      .post(`jobs/${id}/clone`, { json: { scheduled_at: scheduledAt } })
      .json(),
...
export const projectsAPI = {
  list: (includeArchived = false) =>
    api
      .get("projects", { searchParams: { include_archived: includeArchived } })
      .json(),
...
export const systemAPI = {
  ...
  updateConfig: (key, value) =>
    api.patch("system/config", { json: { key, value } }).json(),
